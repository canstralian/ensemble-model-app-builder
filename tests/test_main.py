        ...
        @pytest.mark.parametrize("input_data, expected_output", [
            ("Interactive Data Explorer", "expected code output for this task"),  # Replace with realistic expected outputs
        ...
        def test_generate_app_code_api_error():
            with pytest.raises(SomeExpectedException):  # Adjust based on how you handle errors
