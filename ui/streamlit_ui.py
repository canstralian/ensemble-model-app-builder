...
def render_header():
    ...
    with st.expander("ℹ️ About This Tool"):
        ...
        st.write(
            "This version has been created and expanded upon to utilize multiple models for enhanced code generation."
        )
...
def render_framework_selector():
    ...
    if streamlit_selected:
        ...
        return st.selectbox(
            "Select a framework:", ["Streamlit", "Gradio"], key="framework_fallback"
        )
